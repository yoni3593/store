...
import { Badge, Button, ButtonGroup, Col, Container, Row ,Form} from 'react-bootstrap';
...
function ProductPage() {
  ...
  return (
    <Container className='pt-4' style={{position: 'relative'}}>
        <Row>
            <Col lg={6}>
                <AliceCarousel  items={images} controlsStrategy="alternate"/>
            </Col>
            <Col lg={6} className="pt-4">
                ...
                {user && !user.isAdmin && (
                    <ButtonGroup style={{width: '90%'}}>
                        <Form.Select size='lg' style={{width: '40%', borderRadius: "0"}} onChange={(e) => setCount(e.target.value) }>
